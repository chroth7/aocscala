...
class Day7Suite extends TestSuite {
  ...
  test("Test ops") {
    ...
    // op mode 4
    processAdvancedOps(Seq(4,3,99,0), 0, Seq(1))._1 shouldBe 4 
    processAdvancedOps(Seq(4,5,1002,6,2,0,99), 0, Seq(1))._1 shouldBe 198 
    // add modes 5 6 7 8
  ...
  test("Sequencer") {
    ...
    sequencer(input1, Seq(4,3,2,1,0), (0,0)) shouldBe 43210
    sequencer(input2, Seq(0,1,2,3,4), (0,0)) shouldBe 54321
    sequencer(input3, Seq(1,0,4,3,2), (0,0)) shouldBe 65210
  }
