...
class Day9Suite extends TestSuite {
  ...
  test("Sequencer") {
    val IntProgram(o11, _, i11, _) = IntProgram(0, input1, 0, Seq(4,0)).processAdvancedOps()
    o11 shouldBe 4
    i11 shouldBe 14

    val IntProgram(o12, _, i12, _) = IntProgram(0, input1, 0, Seq(3,4)).processAdvancedOps()
    o12 shouldBe 43
    i12 shouldBe 14

    val IntProgram(o13, _, i13, _) = IntProgram(0, input1, 0, Seq(2,43)).processAdvancedOps()
    o13 shouldBe 432
    i13 shouldBe 14

    val IntProgram(o14, _, i14, _) = IntProgram(0, input1, 0, Seq(1,432)).processAdvancedOps()
    o14 shouldBe 4321
    i14 shouldBe 14

    val IntProgram(o15, _, i15, _) = IntProgram(0, input1, 0, Seq(0,4321)).processAdvancedOps()
    o15 shouldBe 43210
    i15 shouldBe 14

    val ip1 = IntProgram(0, input1, 0, Seq())
    sequencer(ip1, Seq(4,3,2,1,0)) shouldBe 43210

    val ip2 = IntProgram(0, input2, 0, Seq())
    sequencer(ip2, Seq(0,1,2,3,4)) shouldBe 54321
    
    val ip3 = IntProgram(0, input3, 0, Seq())
  ...
  test("Stateful Sequencer") {
    ...
    // stateful, meeeeh
    val ip4 = IntProgram(0, input4, 0, Seq())
